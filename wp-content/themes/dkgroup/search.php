			...
			<div class="articles">
				...
				<?php if(have_posts()) : ?>
					...
					<div class="additional-content">
						...
						<h5><?php _e('Search Results for: ', 'adaptive-framework'); ?><?php echo get_search_query(); ?></h5>
						<hr class="fancy-hr">					
				...
				<?php endwhile; else : ?>
					...
					<h1 class="not-found"><?php _e('No results were found matching your criteria. Please try something else', 'adaptive-framework'); ?></h1>
